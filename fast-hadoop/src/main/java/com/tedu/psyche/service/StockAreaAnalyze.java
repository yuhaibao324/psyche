 ...
 * @date 2019/04/30
 */
public class StockAreaAnalyze {
    private static Logger log = LoggerFactory.getLogger(StockAreaAnalyze.class);
    static String input = "hdfs://192.168.221.115:9000/opt/hadoop/data/stocks.csv";
    static String output="hdfs://192.168.221.115:9000/opt/hadoop/output/area";
    static {
     ...
     *
     */
    public static class DataMap extends Mapper<LongWritable, Text, Text, IntWritable> {
        // 实现map函数
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(StockAreaAnalyze.class);
        // 设置Map和Reduce处理类
